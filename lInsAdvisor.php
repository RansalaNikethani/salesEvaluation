...
<div class="container-fluid min-vh-100">
  <div class="row vh-100">
    ...
    <div class="col-sm-6 col-lg-3 bg-gradient p-3 text-white text-center mw-100">
      ...
      <h5 class="mb-3"><i class="fa-solid fa-user"></i>  &nbsp &nbsp Life Insuarance Advisor</h5>
    ...
    <h3 class="mt-3 mb-4 text-purple">Targets</h3>  
    ...
    <div class="row">
        ...
        <div class="card border-success border-start border-0  mb-4 shadow-sm">            
        <div class="card-body">
        <h5 class="card-title mb-3">Collect LKR 750,000 premium collection per month</h5>
